...
public class frmAdministrarVuelo extends javax.swing.JPanel {
    /* Atributos */
    private  int usuarioSeleccionado;
    VueloBL vueloBL;
    javax.swing.JFrame x;
    ArrayList<Avion> vuelos;
    
    public frmAdministrarVuelo(javax.swing.JFrame x) {
        initComponents();
    ...
    private void initComponents() {
        ...
        registrarUsuario.setText("Registrar Vuelo");
        ...
        jLabel2.setText("ADMINISTRACIÓN DE VUELO");
    ...
    private void borrarCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarCuentaActionPerformed
        ...
        if ( respuesta == 0){// Si se acepta
            if (this.vueloBL.borrarVuelo(this.usuarioSeleccionado)){
