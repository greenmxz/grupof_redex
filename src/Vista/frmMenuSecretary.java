...
public class frmMenuSecretary extends javax.swing.JFrame {
   ...
   private int idLog;
    public frmMenuSecretary(usuario usuarioLog) {
        ...
        new CambiarPanel(panelPrincipal, new Secretario_Administrar_Pedido(this,usuarioLog.getId(),usuarioLog.getPersona().getCiudad()));
    }
    ...
    private void btnPedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPedidosActionPerformed
        new CambiarPanel(panelPrincipal, new Secretario_Administrar_Pedido(this,this.idLog,usuarioLog.getPersona().getCiudad()));
